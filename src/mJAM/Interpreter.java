...
public class Interpreter {
   ...
   final static int running = 0, halted = 1, failedDataStoreFull = 2, failedInvalidCodeAddress = 3, failedInvalidInstruction = 4, failedOverflow = 5,
         failedZeroDivide = 6, failedIOError = 7, failedArrayIndex = 8, failedNullRef = 9, failedHeapRef = 10, failedMethodIndex = 11;
   ...
   static void printHelp() {
      String[] help = { "p or print:", "     print entire machine state", "l or list [offset] [size]:",
            "     print the instructions around CP + offset, with size lines on either side", "     offset = 0 and size = 2 by default",
            "b or break [address]:", "     set a breakpoint at address", "     address = CP by default", "del:", "     delete one or more breakpoints",
            "n or next:", "     execute one instruction", "c or continue:",
            "     continue running the program from current position, until next breakpoint or completion", "r or run:",
            "     run the program from start, until next breakpoint or completion", "i or info:", "     list the current breakpoints", "q, quit or <EOF>:",
            "     quit the debugger", "Simply press enter to repeat the last command", "? or help:", "     print this help" };
