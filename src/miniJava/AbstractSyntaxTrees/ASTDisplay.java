 ...
 * 
 * public Object visitX( X astnode, String arg)
 * 
...
public class ASTDisplay implements Visitor<String, Object> {
   ...
   public Object visitClassType(ClassType type, String arg) {
      show(arg, type);
      show(indent(arg), quote(type.className.spelling) + " [DECLARACTION: " + type.className.decl.name + " (class name)]");
      return null;
   }
   ...
   public Object visitQualifiedRef(QualifiedRef qr, String arg) {
      System.out.println(arg + qr.toString() + " [DECLARACTION: " + qr.decl.name + "]");
   ...
   public Object visitIndexedRef(IndexedRef ir, String arg) {
      System.out.println(arg + ir.toString() + " [DECLARACTION: " + ir.decl.name + "]");
   ...
   public Object visitIdRef(IdRef ref, String arg) {
      System.out.println(arg + ref.toString() + " [DECLARACTION: " + ref.decl.name + "]");
   ...
   public Object visitIdentifier(Identifier id, String arg) {
      show(arg, quote(id.spelling) + " [DECLARACTION: " + id.decl.name + " (" + id.toString() + ")]");
      return null;
   }
